...
function renderLogs(){
  ...
  requestAnimationFrame(()=>{
    ...
    topbarInfo.classList.remove("hidden");
    topbarInfo.style.display = "flex";
    topbarInfo.style.alignItems = "center";
    topbarInfo.style.gap = "10px";
    topbarInfo.style.opacity = "1";
    topbarInfo.style.whiteSpace = "normal";
    topbarInfo.innerHTML = topbarControls;
  });
